...
public class ClassComponent {
    ...
    public String toJson(){
        return "{" +
                ...
                ", \"classImplements\":" + (classImplements == null ? "null" : Arrays.toString(classImplements.toArray())) +
                ", \"classContains\":" + (classContains == null ? "null" : Arrays.toString(classContains.toArray())) +
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getClassInherits(), getClassImplements(), getClassContains(), getClazz());
    }
}
