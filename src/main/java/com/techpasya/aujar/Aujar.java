...
public class Aujar{
    ...
    public static Aujar build(final String startingClassPath, final String boundaryPackagePath) throws AujarException {
    ...
    // TODO This one does not take starting classpath, rather just packagename and builds the whole tree off of packagename.
